  ...
  module Components
    class Sky
      ...
      def draw_sun
        ...
        minutes = pbGetTimeNow.hour * 60 + pbGetTimeNow.min
        oy =
      ...
      def update_stars
        ...
        24.times do |i|
          ...
          @sprites[key].end_y += (@sprites[key].toggle * @sprites[key].speed).lerp
          @sprites[key].opacity = @sprites[key].end_y
          @sprites[key].toggle *= -1 if @sprites[key].opacity < 128 || @sprites[key].opacity > @sprites[key].end_x
        end
      end
      #-------------------------------------------------------------------------
    end
